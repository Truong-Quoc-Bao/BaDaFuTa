...
const resend = new Resend('YOUR_RESEND_API_KEY'); // Thay API Key của bạn vào đây

// 🛑 QUAN TRỌNG: Phải có biến này ở ngoài để lưu OTP
const otpStore: Record<string, { code: number; expiry: number }> = {};
...
export const otpService = {
  ...
  async verifyOtp(email: string, otp: number) {
    ...
    // Nếu không tìm thấy record, báo lỗi "hết hạn" luôn để UI Frontend hiện màu đỏ cho đẹp
    if (!record) {
    ...
    // Xác minh xong thì xóa để không dùng lại được
    delete otpStore[email];
